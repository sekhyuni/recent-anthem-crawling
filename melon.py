...
data = requests.get('https://www.melon.com/chart/index.htm?dayTime=' + now_yymmdd + now_hour, headers=headers)
...
for tr in trs:
     ...
     music_list.append({ 'vendor': 'melon', 'rank': rank, 'title': title, 'album': album, 'artist': artist, 'crawling_time': now_yymmdd + now_hour })
